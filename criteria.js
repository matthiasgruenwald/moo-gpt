...
export async function suggestCriteriaList(activityId, config, genModel, aiClient) {
...
export async function augmentCriteria(activityId, existingCriteria, config, aiClient) {
  const suggestions = await suggestCriteriaList(activityId, config, undefined, aiClient);
