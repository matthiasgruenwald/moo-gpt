...
import { createPromptAssistRouter } from './routes/prompt-assist.js';
...
const activityRouter     = createActivityRouter({ lockManager });
const promptAssistRouter = createPromptAssistRouter({ aiClient });
const adminRouter        = createAdminRouter({ dashboardRegistry });
const costsRouter        = createCostsRouter();
const transcribeRouter   = createTranscribeRouter({ oai });
const speakRouter        = createSpeakRouter({ aiClient });
const dashboardWsRouter  = createDashboardWsRouter({ dashboardRegistry, lockManager });
app.use('/api', activityRouter);
app.use('/api', promptAssistRouter);
app.use('/api', adminRouter);
app.use('/api', costsRouter);
app.use('/api', transcribeRouter);
app.use('/api', speakRouter);
app.use('/api', teacherRouter);
app.use('/api', createErfahrungspromptRouter({ aiClient }));
app.use('/api', createPersonasRouter({ aiClient }));
app.use('/api', createCriteriaRouter({ aiClient }));
app.use('/api', simulationRouter);
app.use('/api', messageEditsRouter);
app.use('/api', studentMemoryRouter);
app.use('/api', createBugReportRouter({ aiClient }));
