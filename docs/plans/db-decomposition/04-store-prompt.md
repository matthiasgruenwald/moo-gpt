...
| Datei | Neuer Import |
|-------|-------------|
| `routes/admin.js` | `import { getActiveSystemPrompt, saveSystemPrompt, getPromptHistory, deletePromptHistoryEntry } from '../stores/prompt.js';` |
...
| `routes/activity.js` | `import { getActiveErfahrungsprompt } from '../stores/prompt.js';` |
| `routes/simulation.js` | `import { getActiveErfahrungsprompt } from '../stores/prompt.js';` |
| `server.js` | `import { getActiveSystemPrompt, saveSystemPrompt, getActiveErfahrungsprompt } from './stores/prompt.js';` |
| `criteria.js` | `import { getActiveErfahrungsprompt } from './stores/prompt.js';` |
| `optimize.js` | `import { getActiveErfahrungsprompt } from './stores/prompt.js';` |
| `chat-session.js` | `import { getActiveErfahrungsprompt, saveErfahrungsprompt } from './stores/prompt.js';` |

---

## Testen

1. `systemctl restart moo-gpt && journalctl -u moo-gpt -n 5 --no-pager` → Logs zeigen `[Config] Systemprompt aus DB`
