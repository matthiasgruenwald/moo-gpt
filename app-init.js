 ...
 * 3. System-Prompt + Modell aus DB laden; bei Erststart leeren Prompt setzen
 *
...
export function initApp(deps = productionDeps) {
  ...
  // 3. Systemprompt + Modell aus DB laden; bei Erststart leeren Prompt setzen
  ...
  if (dbPrompt) {
    ...
    saveSystemPrompt('', MODEL_NAME, 'init');
    updateCachedConfig('', MODEL_NAME);
    console.warn('[Config] Kein Systemprompt in DB — leeren Prompt gesetzt. Bitte im Dashboard konfigurieren.');
  }
}
